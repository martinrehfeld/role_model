...
It works like this:
  ...
  # see all available masks with mentioned role(s)
  >> User.available_masks_for :admin, :author
  => [1,4,3,5,6,7]

  # see masks combinations only with mentioned role(s)
  >> User.masks_only_for :admin, :author
  => [1,4,5]
